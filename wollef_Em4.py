...
[dr,mc,mcp,pdyn,cinf,vG]=rE.loadconnect(pathdir='../',mcinif='mcini_wollef_Em1',experimental=True)
mc = mcp.mcpick_out(mc,'wollef_Em1.pickle')

runname='Wollef_Em4'
mc.soilgrid = np.fmin(mc.soilgrid+2,4) #top soil definition changed
